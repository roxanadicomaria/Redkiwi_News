...
class FileUploader {
    ...
    public function __construct(
        ...
        $this->mediaDirectoryRead = $filesystem->getDirectoryRead(\Magento\Framework\App\Filesystem\DirectoryList::MEDIA);
     ...
     * @return string
     */
    public function getFileAbsoultePath($fileName) {
        $basePath = $this->getBasePath();        
        $baseImagePath = $this->getFilePath($basePath, $fileName);
        return $this->mediaDirectoryRead->getAbsolutePath($baseImagePath);
    }
    ...
    public function getFile($fileName) {
        $basePath = $this->getBasePath();        
        $baseImagePath = $this->getFilePath($basePath, $fileName);
        return $this->mediaDirectoryRead->openFile($baseImagePath);
    }
